...
CREATE TABLE [dbo].[tbl_firs_single_tax_transactions_detail](
	...
	[transaction_currency] [nvarchar](256) NULL,
	[currency_invoiced_value] [nvarchar](256) NULL,
	[currency_exchange_rate] [nvarchar](256) NULL,
	[transaction_invoiced_value] [nvarchar](256) NULL,
	[wvat_rate] [nvarchar](256) NULL,
	[wvat_value] [nvarchar](256) NULL,
	[tax_account_number] [nvarchar] (256) NULL,
...
@transaction_currency [nvarchar](256),
@currency_invoiced_value [nvarchar](256),
@currency_exchange_rate [nvarchar](256),
@transaction_invoiced_value [nvarchar](256),
@wvat_rate [nvarchar](256),
@wvat_value [nvarchar](256) NULL,
@tax_account_number [nvarchar](256),
...
AS
	...
	SET error=@error, row_status=@row_status, customer_name = @customerName, batch_convenience_fee=@batchFee, 
	transaction_convenience_fee  = @transactionFee
	WHERE transactions_summary_id=@transactions_summary_id and row_num=@row_num;
GO
