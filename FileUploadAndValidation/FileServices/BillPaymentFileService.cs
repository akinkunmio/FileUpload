...
//{
//    public class BillPaymentFileService : IFileService
//    {
...
//        public BillPaymentFileService(IDbRepository dbRepository, 
...
//        public async Task<PagedData<BillPaymentRowStatusTyped>> GetPaymentResults(string batchId, PaginationFilter pagination)
//        {
//            IEnumerable<BillPayment> billPayments = new List<BillPayment>();
//            IEnumerable<BillPaymentRowStatusTyped> billPaymentStatuses = default;
//            int totalRowCount;
//            double validAmountSum;

//            try
//            {
//                var billPaymentStatusesObj = await _dbRepository.GetPaymentRowStatuses(batchId, pagination);

//                totalRowCount = billPaymentStatusesObj.TotalRowsCount;

//                validAmountSum = billPaymentStatusesObj.ValidAmountSum;

//                billPaymentStatuses = billPaymentStatusesObj.RowStatusDtos.Select(s => new BillPaymentRowStatusTyped
//                 {
//                      Amount = s.Amount,
...
//            return new PagedData<BillPaymentRowStatusTyped> { Data = billPaymentStatuses, TotalRowsCount = totalRowCount, TotalAmountSum = validAmountSum };
//        }
